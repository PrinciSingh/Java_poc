...
<div id="container">
  ...
  <div id="body">
    <div>
      <p>&nbsp;</p>
      <p>&nbsp;</p>
      <form name="frm1" action="forgotpassword_email_code.jsp" method="post" onsubmit="return checkBlankField()">
      <table width="556"  align="center" cellpadding="9" cellspacing="0" class="ctable">
        <tr>
          <td width="154"><div align="right"><span class="style7">Enter Email </span></div></td>
          <td colspan="2"><label>
            <input name="email" type="text" class="rfield"/>
          </label></td>
        </tr>
        <tr>
            <td></td>
